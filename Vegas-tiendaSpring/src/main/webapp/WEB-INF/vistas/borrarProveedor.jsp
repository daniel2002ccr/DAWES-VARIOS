...
<body>
	...
	<div class="container">
		...
		<div class="form">
			<form
				action="http://localhost:8080/tienda/proveedores/formularioborrarproveedor"
				method="POST">
...
<h3>Resultados de la busqueda</h3>
		<c:forEach items="${lista}" var="proveedor">
			<div class="form">
				<form
					action="http://localhost:8080/tienda/proveedores/borrarproveedor"
					method="POST">
					...
					<br> <input type="submit" id="boton" value="Borrar">
				</form>
			</div>
		</c:forEach>
